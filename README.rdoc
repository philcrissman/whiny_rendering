...
WhinyRendering is a gem for Rails which provides a method for ActionView that returns a div listing the current controller, action, template being rendered, and a list of all the partials being used in that view as well.
